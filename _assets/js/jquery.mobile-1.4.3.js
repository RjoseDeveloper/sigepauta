...
(function( $, window, undefined ) {
	$.extend( $.mobile, {
		...
		// Deprecated in 1.4 remove in 1.5
		// Class used for "active" button state, from CSS header
		activeBtnClass: "ui-btn-active",

		// Deprecated in 1.4 remove in 1.5
		// Class used for "focus" form element state, from CSS header
		focusClass: "ui-focus",
...
(function( $, window, undefined ) {
	...
	$.extend( $.mobile, {
		...
		// Namespace used header-wide for data-attrs. Default is no namespace
