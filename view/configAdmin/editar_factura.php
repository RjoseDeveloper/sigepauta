<?php
	...
	$active_clientes="";
	$active_usuarios="";	
	$title="Editar Factura | Sistama de Faturas";
				  ...
				  <label for="tel1" class="col-md-1 control-label">Telefone</label>
					...
					<label for="mail" class="col-md-1 control-label">Email</label>
						...
						<div class="form-group row">
							...
							<label for="tel2" class="col-md-1 control-label">Fechar</label>
							<div class="col-md-2">
							...
							<div class="col-md-2">
								<select class='form-control input-sm ' id="estado_factura" name="estado_factura">
									<option value="1" <?php if ($estado_factura==1){echo "selected";}?>>Pago</option>
									<option value="2" <?php if ($estado_factura==2){echo "selected";}?>>Pendente</option>
								</select>
							</div>
						</div>
				...
				<div class="col-md-12">
					<div class="pull-right">
						...
						<button type="button" class="btn btn-default" data-toggle="modal" data-target="#nuevoCliente">
						 <span class="glyphicon glyphicon-user"></span> Novo Utilizador
						</button>
						<button type="button" class="btn btn-default" data-toggle="modal" data-target="#myModal">
						 <span class="glyphicon glyphicon-search"></span> Adicionar Disciplinas
						</button>
	...
	<script>
		$(function() {
						$("#nombre_cliente").autocomplete({
							source: "./ajax/autocomplete/alunos.php",
							minLength: 2,
