  ...
  <body>
    ...
    <div class="container">
		...
		<div class="panel-heading">
			...
			<?php
			include("modal/form_spayments.php");
			include("modal/editar_spayments.php");
			?>
	...
	include("footer.php");
	?>
	<script type="text/javascript" src="js/payments_session.js"></script>
