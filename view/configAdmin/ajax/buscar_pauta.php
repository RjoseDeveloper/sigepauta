<?php
    ...
    require '../../../QuerySql/AllQuerySQL.php';
    require '../../../QuerySql/DocenteSQL.php';
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<a href="#" class='btn btn-default' title='Editar Pauta' data-backdrop="false"
                      onclick="editar_pauta('<?php echo $_id;?>');" data-toggle="modal" data-target="#md_edit_pauta"><i class="glyphicon glyphicon-edit"></i></a>
                            ...
                            <a href="#" class='btn btn-default' title='Listar Pauta' data-backdrop="false"
                      onclick="list_pauta('<?php echo $_id;?>');" data-toggle="modal" data-target="#md_edit_pauta">
