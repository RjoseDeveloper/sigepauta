<?php
	...
	if (empty($_POST['mod_id'])) {
           ...
           $errors[] = "Código vacío";
			...
			$errors[] = "Nome do Produto esta vazio";
		} else if ($_POST['mod_estado']==""){
			$errors[] = "Selecciona o estado do produto";
		} else if (empty($_POST['mod_precio'])){
			$errors[] = "Precio de venda esta vazio";
		} else if (
			!empty($_POST['mod_id']) &&
		...
		$query_update = mysqli_query($con,$sql);
			if ($query_update){
				...
				$errors []= "Problemas com o sistema, tente novamente.".mysqli_error($con);
			}
		} else {
