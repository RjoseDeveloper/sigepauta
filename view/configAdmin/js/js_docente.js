            ...
            if (c > 0 && disp > 0 && av > 0){
                ...
                $.ajax({
                    ...
                    success : function(results){
                        ...
                        $('#md_relatorios').modal({backdrop:false}); // abrir um popup model
                        $('.get_estudante').show('slow');
                ...
                if (temp === false  && nrmec.length > 0 && notas.length > 0){
                    ...
                    for (var i =0; i< nrmec.length; i++){
                        ...
                        $.ajax({
                            ...
                            success: function(dados){
                                $('.valida_nota').html('<h4>Pauta Enviada com sucesso total  '+i+'#  estudante(s).</h4>')
                                    .css({'color': 'blue','font-size':'18px'}).fadeOut(6000);;
                                temp = true;
                                load(1);
                            }
                        });
